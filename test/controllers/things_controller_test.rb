...
class ThingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post things_url, params: { thing: { created_at: @thing.created_at, name: @thing.name, thing_id: @thing.thing_id, updated_at: @thing.updated_at } }
    end
  ...
  test "should update thing" do
    patch thing_url(@thing), params: { thing: { created_at: @thing.created_at, name: @thing.name, thing_id: @thing.thing_id, updated_at: @thing.updated_at } }
